...
public class MyPurchasesModel {
    ...
    public MyPurchasesModel(String product_Name, String unit_Name, String expiresAt, String address, String town, String geo_State, String country, String email, String name, String identification, String phone, int stock_Qty, int id_Order, double pricePerUnit) {
